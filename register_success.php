        ...
        <section class="sign-in-up-content">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <h4 class="text-center">Pendaftaran berjaya!</h4>

			  Tahniah! Transaksi berjaya. Sila log masuk ke akaun anda.
			  
			  <form class="sign-in-up-form" action="login.php" role="form">
                
                
                <!-- Button -->
                <button class="btn btn-success btn-block" type="submit">Log Masuk</button>
